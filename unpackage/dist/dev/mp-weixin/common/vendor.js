...
/***/ 15:
/*!*******************************************!*\
  !*** E:/ceshi/app_dian/common/request.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _urlconfig = _interopRequireDefault(__webpack_require__(/*! ./urlconfig.js */ 16));
var _user = _interopRequireDefault(__webpack_require__(/*! ./user.js */ 17));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // 引入配置文件
var _default = {
  //请求设置
  config: {
    baseUrl: _urlconfig.default.webUrl,
    v2url: _urlconfig.default.v2Url,
    header: {
  ...
  request: function request() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    if (options.token) {
      ...
      options.header.dian_token = _user.default.token;
    }
  ...
  /**注册开始*/
  requestV2: function requestV2() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    options.header = options.header || this.config.header; //options.header=如果有传就是options.header || 如果没传就等于默认值
    options.method = options.method || this.config.method;
    options.dataType = options.dataType || this.config.dataType;
  ...
  getV2: function getV2(url, data) {var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    options.url = url;
    options.data = data;
    options.method = 'GET';
    return this.requestV2(options);
  },
  postV2: function postV2(url, data) {var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    options.url = url;
    options.data = data;
    options.method = 'POST';
    options.header = {
  ...
  // 网络错误处理
  errorCheckRe: function errorCheckRe(err, msg) {
    if (err) {
      typeof errfun === 'function' && errfun();
      uni.showToast({
  ...
  //处理登陆注册返回业务
  checkLog: function checkLog(res, reg) {
    console.log(res);
    var dataRes = res.data;
    if (dataRes.status === 0) {
      var ss = JSON.parse(dataRes.data);
      uni.setStorage({
        key: "dian_token",
        data: ss.dian_token });

      var user = JSON.parse(ss.user);
      uni.setStorage({
        key: "username",
        data: user.username });
  ...
  //生成uuid
  getUuid: function getUuid(checkAuth) {
...
/***/ 16:
/*!*********************************************!*\
  !*** E:/ceshi/app_dian/common/urlconfig.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; /* 请求配置信息*/var _default =
{
  // api请求前缀
...
/***/ 17:
/*!****************************************!*\
  !*** E:/ceshi/app_dian/common/user.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!*****************************************************!*\
  !*** E:/ceshi/app_dian/pages.json?{"type":"style"} ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/reg/reg": { "navigationBarTitleText": "注册", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/login/login": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/pwd/pwd": { "navigationBarTitleText": "找回密码", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/index/index": { "navigationBarTitleText": "首页", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/home/home": { "navigationBarTitleText": "我的", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/xieyi/xieyi": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/logmain/logmain": { "navigationBarTitleText": "", "usingComponents": {}, "usingAutoImportComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 71:
/*!*************************************************!*\
  !*** E:/ceshi/app_dian/common/log/logmainjs.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 8:
/*!****************************************************!*\
  !*** E:/ceshi/app_dian/pages.json?{"type":"stat"} ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
