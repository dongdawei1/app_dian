<template>
	<view class="mybody">
		...
		<view class="sou2 ">
			<view class="gao2 hui">
				<view class="shang2">{{ realName.companyName }}</view>
			</view>
		</view>
		...
		<view class="gerenzhongxinbut"><button class="mini-class" @click="save()" type="primary" :loading="loading">提交招聘信息</button></view>
	</view>
</template>
